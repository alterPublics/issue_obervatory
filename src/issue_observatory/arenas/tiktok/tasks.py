...
def tiktok_collect_terms(
    ...
    **_extra: Any,
    ...
    try:
        ...
        logger.info(
            "tiktok: collect_by_terms completed — run=%s records=%d inserted=%d skipped=%d",
            collection_run_id,
            count,
            inserted,
            skipped,
        ...
        logger.error(
            "tiktok: collect_by_terms timed out after 10 minutes — run=%s",
            collection_run_id,
        )
        _update_task_status(
            collection_run_id,
...
def tiktok_collect_actors(
    ...
    **_extra: Any,
    ...
    try:
        ...
        logger.info(
            "tiktok: collect_by_actors completed — run=%s records=%d inserted=%d skipped=%d",
            collection_run_id,
            count,
            inserted,
            skipped,
        ...
        logger.error(
            "tiktok: collect_by_actors timed out after 10 minutes — run=%s",
            collection_run_id,
        )
        _update_task_status(
            collection_run_id,
