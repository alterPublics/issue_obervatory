...
async def _bootstrap() -> None:
    ...
    print(
        "\nNext steps:\n"
        "  1. Log in at  http://localhost:8022/auth/login\n"
        "  2. Activate researcher accounts at  http://localhost:8022/admin/users\n"
        "  3. Allocate credits at  http://localhost:8022/admin/credits/allocate\n"
    )
